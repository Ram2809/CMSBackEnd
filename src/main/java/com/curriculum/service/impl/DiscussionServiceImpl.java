...
//	@Override
//	public Discussion addDiscussion(Discussion discussionDetails) throws BusinessServiceException, NotFoundException {
//		try {
//			topicRepository.checkTopic(discussionDetails.getTopic().getUnitNo());
